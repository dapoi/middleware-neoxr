...
const allowedApiEndpoints = ['/', '/app-config', '/auth-check', '/fb', '/ig', '/meta', '/pin-v2', '/spotify', '/terabox', '/threads', '/tiktok', '/twitter', '/videy', '/youtube', '/goimg'];
...
app.use('/api', (req, res, next) => {
  ...
  const downloadEndpoints = ['/fb', '/ig', '/meta', '/pin-v2', '/spotify', '/terabox', '/threads', '/tiktok', '/twitter', '/videy', '/youtube', '/goimg'];
