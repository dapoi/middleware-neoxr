...
const allowedApiEndpoints = ['/', '/app-config', '/applemusic', '/auth-check', '/douyin', '/fb', '/goimg', '/ig', '/meta', '/pin-v2', '/snackvid', '/soundcloud', '/spotify', '/terabox', '/threads', '/tiktok', '/twitter', '/videy', '/youtube'];
...
app.use('/api', (req, res, next) => {
  ...
  const downloadEndpoints = ['/applemusic', '/douyin', '/fb', '/goimg', '/ig', '/meta', '/pin-v2', '/snackvid', '/soundcloud', '/spotify', '/terabox', '/threads', '/tiktok', '/twitter', '/videy', '/youtube'];
