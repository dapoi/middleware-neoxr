...
const allowedApiEndpoints = ['/', '/app-config', '/report', '/applemusic', '/auth-check', '/bardimg', '/douyin', '/fb', '/genimg', '/goimg', '/ig', '/meta', '/pin', '/pin-v2', '/pinterest-v2', '/pixiv', '/soundcloud', '/spotify', '/terabox', '/threads', '/tiktok', '/twitter', '/videy', '/youtube'];
...
app.use('/api', (req, res, next) => {
  ...
  const downloadEndpoints = ['/applemusic', '/bardimg', '/douyin', '/fb', '/genimg', '/goimg', '/ig', '/meta', '/pin', '/pin-v2', '/pinterest-v2', '/pixiv', '/soundcloud', '/spotify', '/terabox', '/threads', '/tiktok', '/twitter', '/videy', '/youtube'];
